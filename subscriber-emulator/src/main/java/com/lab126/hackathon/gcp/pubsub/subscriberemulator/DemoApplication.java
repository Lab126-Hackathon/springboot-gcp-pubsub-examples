package com.lab126.hackathon.gcp.pubsub.subscriberemulator;
...
public class DemoApplication {
	...
	public static void main(String[] args) throws Exception {
		...
		Subscriber subscriber = null;
			...
			try {
		  	subscriber = Subscriber.newBuilder(subscriptionName, receiver).setChannelProvider(channelProvider).setCredentialsProvider(credentialsProvider).build();
